...
class PropertiesRepository(context: Context) {
    ...
    init {
        ...
        groups.add(Group(1, "#8DE541", "lime",50))
        groups.add(Group(2, "#FF0000", "red",50))
        groups.add(Group(3, "#003366", "blue",100))
        groups.add(Group(4, "#FF8000", "orange",100))
        groups.add(Group(5, "#00FFFF", "lightblue",150))
        groups.add(Group(6, "#FFFF00", "yellow",150))
        groups.add(Group(7, "#20540D", "green",200))
        groups.add(Group(8, "#190033", "purple",200))
